...
public class CompanyConverter implements JsonDeserializer<Company> {
    ...
    @Override
    public Company deserialize(JsonElement je, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        if (je.getAsJsonObject().get("type") != null && Company.TYPE.equals(je.getAsJsonObject().get("type").getAsString())) {
